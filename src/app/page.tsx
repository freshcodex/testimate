          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground">
                The easiest way to gather social proof, build trust, and display
                testimonials that convert. All in one place.
              </p>
        ...
        <div className="bg-secondary py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground">
                From collection to display, we make it effortless to gather and
                showcase the social proof that drives your business forward.
              </p>
            </div>
        ...
        <div className="bg-background py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-muted-foreground">
                Join thousands of teams who are already using Testimate to build
